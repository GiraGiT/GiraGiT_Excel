...
Sub DataReconciliation()
    ...
    ' Запрос режима
    mode = Application.InputBox("Выберите режим: 1 - Точные совпадения, 2 - Алгоритм Левенштейна", Type:=1)
    ...
    If mode = 2 Then
        similarityThreshold = 0.8 ' Установите пороговое значение для процентного соотношения совпадений
    End If
    ...
    ' Удаление существующих комментариев и очистка заливки ячеек
